...
The first controlled power-plant sample also uses the current frontend map payload:

```text
source: frontend/public/data/atlas_web_data.json
FDE table: app_atlas.power_plants_sample
rows: 1,000
```
...
The application power-plant endpoint is:
